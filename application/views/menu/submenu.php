...
<div class="container-fluid">
  ...
  <tbody>
    ...
    <tr>
      ...
      <!-- <td onclick="javascript: return confirm('Yakin ingin menghapus?')"> <?php echo anchor('menu/delete_submenu/' . $sm->id, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
    </tr> -->
    <?php $i ++; ?>
    <?php endforeach; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="newSubMenuModal">Add New Sub Menu</h5>
